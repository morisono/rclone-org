...
```
      ...
      --config string                       Config file (default "/home/user/.config/rclone/rclone.conf")
...
```
      ...
      --cache-chunk-path string                             Directory to cache chunk files (default "/home/user/.cache/rclone/cache-backend")
      ...
      --cache-db-path string                                Directory to store file structure metadata DB (default "/home/user/.cache/rclone/cache-backend")
